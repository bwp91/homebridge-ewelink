...
module.exports = {
  ...
  simErrNoSensor: 'defined sensor does not exist in Homebridge',
  simErrNotSensor: 'defined sensor is not a DW2 sensor',
  simErrNotConfSensor: 'defined sensor is not configured as a sensor',
  simErrSetup: "device has not been set up as 'oneSwitch' or 'twoSwitch'",
