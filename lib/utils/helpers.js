...
module.exports = {
  ...
  allowedGroups: [
    ...
    'garage_eachen', 'lock', 'switch_valve', 'tap',
    'tap_two', 'thermostat', 'valve', 'valve_two',
    'valve_four'
  ],
  defaults: {
  ...
  devicesRFBridge: [28],
  devicesZBBridge: [66],
  devicesZBSwitchStateless: [1000],
  devicesZBSwitchSingle: [1009, 1256],
  devicesZBLightDimmer: [1257],
  devicesZBSensorAmbient: [1770],
  devicesZBSensorMotion: [2026],
  devicesZBSensorContact: [3026],
  paramsToKeep: [
