...
module.exports = {
  ...
  allowedGroups: [
    ...
    'garage_eachen', 'lock', 'tap_one', 'switch_valve',
    'valve', 'valve_two'
  ],
  defaults: {
  ...
  m2hs: m => {
    /*
      table from (and credit to) HAP-NodeJS
      it's here so it can be used for users with HB < 1.3
      https://github.com/homebridge/HAP-NodeJS/blob/beta/src/lib/util/color-utils.ts
    */
    const table = {
      100: [19, 222.1],
      101: [18.7, 222.2],
