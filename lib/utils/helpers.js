...
module.exports = {
  ...
  hs2rgb: hs => {
    ...
    switch (hi) {
      case 0:
        toReturn = [255, 255 * (1 - (s * (1 - f))), 255 * (1 - s)]
        break
      case 1:
        toReturn = [255 * (1 - (s * f)), 255, 255 * (1 - s)]
        break
      case 2:
        toReturn = [255 * (1 - s), 255, 255 * (1 - (s * (1 - f)))]
        break
      case 3:
        toReturn = [255 * (1 - s), 255 * (1 - (s * f)), 255]
        break
      case 4:
        toReturn = [255 * (1 - (s * (1 - f))), 255 * (1 - s), 255]
        break
      case 5:
        toReturn = [255, 255 * (1 - s), 255 * (1 - (s * f))]
        break
    }
    return toReturn
  },
