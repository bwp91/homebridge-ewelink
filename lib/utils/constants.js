...
module.exports = {
  ...
  allowed: {
    ...
    modes: ['auto', 'wan', 'lan'],
    singleDevices: ['deviceId', 'label', 'showAsOutlet', 'ipAddress', 'overrideDisabledLogging'],
    multiDevices: [
      'deviceId',
      'label',
      'showAsOutlet',
  ...
  devices: {
    lanIn: [1, 2, 3, 4, 5, 6, 7, 8, 9, 14, 15, 28, 32, 34, 44, 77, 78, 103, 104, 126],
    lanOut: [1, 2, 3, 4, 5, 6, 7, 8, 9, 14, 15, 28, 32, 34, 44, 77, 78, 126],
    singleSwitch: [1, 5, 6, 14, 24, 27, 112],
    doubleSwitch: [126],
    multiSwitch: [2, 3, 4, 7, 8, 9, 29, 30, 31, 41, 82, 83, 84, 113, 114],
