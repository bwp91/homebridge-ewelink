...
module.exports = {
  ...
  messages: {
    ...
    wsLogin406: 'WS login failed [406] please see http://bit.ly/hb-ewelink-err-406',
  ...
  allowed: {
    ...
    multiDevices: [
      'deviceId', 'showAsOutlet', 'hideChannels', 'ipAddress', 'overrideDisabledLogging'
    ],
    outletDevices: [
  ...
  devices: {
    ...
    singleSwitch: [1, 5, 6, 14, 15, 22, 24, 27, 32, 36, 44, 59, 81, 104],
    multiSwitch: [2, 3, 4, 7, 8, 9, 29, 30, 31, 34, 41, 82, 83, 84],
