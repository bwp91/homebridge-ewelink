...
module.exports = {
  ...
  paramsToKeep: [
    ...
    'motion', 'motorTurn', 'online', 'power', 'rfChl', 'rfList', 'rfTrig', 'sensorType',
    'setclose', 'state', 'switch', 'switches', 'targetTemp', 'temperature', 'tempScale',
    'trigTime', 'type', 'voltage', 'white', 'workMode', 'workState', 'zyx_mode'
  ],
