...
module.exports = {
  ...
  allowed: {
    ...
    fanDevices: ['deviceId', 'deviceModel', 'label', 'hideLight', 'ipAddress', 'overrideLogging'],
    sensorDevices: [
      'deviceId',
      'deviceModel',
      'label',
    ...
    showAsMotor: ['blind', 'door', 'window']
  },

  devices: {
    lan: [1, 2, 3, 4, 5, 6, 7, 8, 9, 14, 15, 28, 32, 34, 44, 77, 78, 126],
    singleSwitch: [1, 6, 14, 24, 27, 112, 1009, 1256],
    multiSwitch: [2, 3, 4, 7, 8, 9, 29, 30, 31, 41, 82, 83, 84, 113, 114, 126, 2256, 3256, 4256],
