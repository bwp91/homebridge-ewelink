...
module.exports = {
  defaultConfig: {
    ...
    debugFakegato: false,
    disablePlugin: false,
    hideChanFromHB: '', // multiDevices{}
    switchAsOutlet: '', // singleDevices{}
    outletAsSwitch: '', // outletDevices{}
    inUsePowerThreshold: 0, // outletDevices{}
    hideLightFromFan: '', // fanDevices{}
    hideSwitchFromTH: '', // thDevices{}
    lowBattThreshold: 25, // sensorDevices{}
    sensorTimeDifference: 120, // sensorDevices{}
    bulbB02BA60: '', // lightDevices{}
    bulbB02FST64: '', // lightDevices{}
    thTempOffset: [], // thDevices{}
    hideZBLDPress: false, // sensorDevices{}
    ZBDWBatt: false, // sensorDevices{}
    groups: [],
    bridgeSensors: [],
    ipOverride: [],
    ignoredDevices: [],
  ...
  allowed: {
    groups: [
      ...
      'switch_valve', 'tap', 'tap_two', 'thermostat', 'valve', 'valve_two', 'valve_four'
    ],
    modes: ['auto', 'wan', 'lan'],
