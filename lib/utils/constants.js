...
module.exports = {
  ...
  devices: {
    ...
    markStatus: [1009, 1256, 1257, 1258],
    ...
    cannotSupport: [65, 118, 119, 120, 121]
  },
  ...
  paramsToKeep: [
    ...
    'lock', 'ltype', 'mainSwitch', 'mode', 'motion', 'motorTurn', 'online', 'power',
    'rfChl', 'rfList', 'rfTrig', 'sensorType', 'setclose', 'state', 'switch', 'switches',
    'targetTemp', 'temperature', 'tempScale', 'trigTime', 'type', 'voltage', 'white',
    'workMode', 'workState', 'zyx_mode'
  ],
