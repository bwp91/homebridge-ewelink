...
module.exports = {
  ...
  devices: {
    lan: [1, 2, 3, 4, 5, 6, 7, 8, 9, 14, 15, 28, 32, 34, 44, 77, 78, 112, 113, 114, 126, 133, 160],
    switchSingle: [1, 6, 14, 24, 27, 1009, 1256],
    switchSCM: [77, 78, 81, 107, 112, 138],
    ...
    switchMultiPower: [126],
    lightDimmer: [36, 44, 57],
    lightRGB: [22],
    lightCCT: [103],
    lightRGBCCT: [59, 104, 137],
    curtain: [11, 67],
    sensorContact: [102],
    sensorAmbient: [15],
    sensorTempHumi: [18],
  ...
  supportedDevices: {
    ...
    140: 3, // "MINIR3?"
    141: 4, // "MINIR3?"
    160: 3, // "SwitchMan Smart Wall Switch-M5 - 3 Gang"
