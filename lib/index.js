        ...
        case 'groups':
          if (Array.isArray(val) && val.length > 0) {
            val.forEach(x => {
              ...
              this.log.warn(
                '[%s - %s] Please recreate this simulation in the Single/Multi Channel Devices section of the configuration and remove this entry from the Accessory Simulations section.',
                id,
                x.type
              )
              for (const [k, v] of entries) {
