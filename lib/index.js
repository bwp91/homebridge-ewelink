...
class eWeLinkPlatform {
  ...
  async initialiseDevice (device) {
    try {
      ...
      if (this.consts.devices.switchMultiPower.includes(uiid) && device.params.workMode === 2) {
        /*************************
        ...
        *************************/
        ...
        this.ignoredDevices.push(device.deviceid)
        return
      } else if (this.consts.devices.panel.includes(uiid)) {
        /******
        NSPANEL
        ******/
        accessory = devicesInHB.get(uuid) || this.addAccessory(device, device.deviceid + 'SWX')
        accessory.control = new (require('./device/panel'))(this, accessory)
        /*****/
        ...
        *****************************************/
        ...
        accessory.control = new (require('./device/simulation/th-thermostat'))(this, accessory)
        /****************************************/
        ...
        *************************************/
        accessory = devicesInHB.get(uuid) || this.addAccessory(device, device.deviceid + 'SWX')
        accessory.context.sensorType = device.params.sensorType
        accessory.control = new (require('./device/simulation/th-heater'))(this, accessory)
        /************************************/
        ...
        *************************************/
        accessory = devicesInHB.get(uuid) || this.addAccessory(device, device.deviceid + 'SWX')
        accessory.context.sensorType = device.params.sensorType
        accessory.control = new (require('./device/simulation/th-cooler'))(this, accessory)
        /************************************/
      } else if (
        ...
        *****************************************/
        ...
        accessory = devicesInHB.get(uuid) || this.addAccessory(device, device.deviceid + 'SWX')
        accessory.context.sensorType = device.params.sensorType
        accessory.control = new (require('./device/simulation/th-humidifier'))(this, accessory)
        /*****************************************/
      } else if (
        ...
        *******************************************/
        ...
        accessory = devicesInHB.get(uuid) || this.addAccessory(device, device.deviceid + 'SWX')
        accessory.context.sensorType = device.params.sensorType
        accessory.control = new (require('./device/simulation/th-dehumidifier'))(this, accessory)
        /*******************************************/
        ...
        **************/
        ...
        this.consts.devices.switchSCMPower.includes(uiid)
      ) {
        /********************************
        ...
        *******************************/
        ...
        /******************************/
      } else if (this.consts.devices.switchMate.includes(uiid)) {
        /*******************
        SWITCH MATE (S-MATE)
        *******************/
        accessory = devicesInHB.get(uuid) || this.addAccessory(device, device.deviceid + 'SWX')
        accessory.control = new (require('./device/switch-mate'))(this, accessory)
        /******************/
        ...
        ***************/
        ...
        /**************/
      } else if (this.consts.devices.zbSensorSmoke.includes(uiid)) {
        /****************
        ZB SENSOR [SMOKE]
        ****************/
        accessory = devicesInHB.get(uuid) || this.addAccessory(device, device.deviceid + 'SWX')
        accessory.control = new (require('./device/zigbee/sensor-smoke'))(this, accessory)
        /***************/
        ...
        *************/
        ...
        return
        /************/
      } else if (this.consts.devices.template.includes(uiid)) {
        /***********
        TEMPLATE DEV
        ***********/
        accessory = devicesInHB.get(uuid) || this.addAccessory(device, device.deviceid + 'SWX')
        accessory.control = new (require('./device/template'))(this, accessory)
        /**********/
      ...
      if (this.storageClientLAN && this.consts.devices.lan.includes(uiid)) {
        try {
