              ...
              for (const [k, v] of Object.entries(x)) {
                switch (k) {
                  ...
                  case 'overrideDisabledLogging':
                    ...
                    this.rfDevices[fullDeviceId][k] = v === 'false' ? false : !!v
                    break
                  ...
                  case 'sensorTimeLength': {
                    ...
                    if (isNaN(intVal)) {
                      ...
                      this.rfDevices[fullDeviceId][k] = this.consts.defaultValues[k]
                    } else if (intVal < this.consts.minValues[k]) {
                      logIncrease(key + '.' + k, this.consts.minValues[k])
                      this.rfDevices[fullDeviceId][k] = this.consts.minValues[k]
                    } else {
                      this.rfDevices[fullDeviceId][k] = intVal
                    }
                    break
                  }
                  case 'type':
                    if (typeof v !== 'string' || v === '') {
                      ...
                      this.rfDevices[fullDeviceId][k] = v
                    }
                    break
                  default:
                    logRemove(key + '.' + k)
              ...
              for (const [k, v] of Object.entries(x)) {
                switch (k) {
                  ...
                  case 'overrideDisabledLogging':
                    ...
                    this.simulations[deviceId][k] = v === 'false' ? false : !!v
                    break
                  case 'sensorId':
                    if (typeof v !== 'string' || v === '') {
                      logIgnore(key + '.' + k)
              ...
              for (const [k, v] of Object.entries(x)) {
                switch (k) {
                  ...
                  case 'overrideDisabledLogging':
                    ...
                    this.lightDevices[deviceId][k] = v === 'false' ? false : !!v
                    break
                  default:
                    logRemove(key + '.' + k)
                    break
              ...
              for (const [k, v] of Object.entries(x)) {
                switch (k) {
                  ...
                  case 'overrideDisabledLogging':
                    ...
                    this.multiDevices[deviceId][k] = v === 'false' ? false : !!v
                    break
                  default:
                    logRemove(key + '.' + k)
                    break
