        ...
        *********************/
        ...
        rfMap.forEach(subDevice => {
          ...
          if (['1', '2', '3', '4'].includes(subDevice.type)) {
            ...
            subType = 'curtain'
          } else if (['6', '7'].includes(subDevice.type)) {
            subType = this.rfDevices[fullDeviceId] && subDevice.type === '6'
            ...
            const params = JSON.stringify(device.params)
            this.log.warn('[%s-%s] %s', device.extra.uiid, subDevice.type || '?', params)
            return
          }
