      ...
      if (this.consts.devices.curtain.includes(device.extra.uiid)) {
        ...
        *********************/
        ...
        rfMap.forEach(subDevice => {
          ...
          const lowCaseDeviceId = device.deviceid + 'sw' + swNumber
          ...
          if (['1', '2', '3', '4'].includes(subDevice.type)) {
            ...
            subType = this.rfSensors[lowCaseDeviceId]
              ? this.rfSensors[lowCaseDeviceId].type
              : 'motion'
            if (this.rfSensors[lowCaseDeviceId]) {
              sensorTimeLength = this.rfSensors[lowCaseDeviceId].sensorTimeLength
            }
          } else {
