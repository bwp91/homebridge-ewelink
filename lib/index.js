    ...
    try {
      ...
      if (uiid === 126 && device.params.workMode === 2) {
        ...
        *******************/
        ...
        this.simulations[device.deviceid] &&
        this.simulations[device.deviceid].type === 'p_button'
      ) {
        /*******************************
        ...
        *******************************/
        ...
        this.simulations[device.deviceid] &&
        this.simulations[device.deviceid].type === 'doorbell'
      ) {
        /********************
        DOORBELL [SIMULATION]
        ********************/
        ...
        *******************/
        accessory = devicesInHB.get(uuid) || this.addAccessory(device, device.deviceid + 'SWX')
        let instance
        switch (this.sensorDevices[device.deviceid] && this.sensorDevices[device.deviceid].showAs) {
          case 'sensor_leak':
            instance = 'simulation/sensor-leak'
            break
          default:
            instance = 'sensor-contact'
            break
        }
        ...
        ****************/
        ...
        let instance
        switch (this.thDevices[device.deviceid] && this.thDevices[device.deviceid].showAs) {
          case 'cooler':
            instance = 'simulation/cooler'
            break
          case 'dehumidifier':
            ...
            instance = 'simulation/dehumidifier'
            break
          case 'heater':
            instance = 'simulation/heater'
            break
          case 'humidifier':
            if (device.params.sensorType === 'DS18B20') {
              if (devicesInHB.has(uuid)) {
            ...
            instance = 'simulation/humidifier'
            break
          default:
            instance = 'sensor-ambient'
            break
        }
        accessory.control = new (require('./device/' + instance))(this, accessory)
        /***************/
