...
class eWeLinkPlatform {
    ...
    for (const [key, val] of Object.entries(config)) {
      switch (key) {
        ...
        case 'groups':
          if (Array.isArray(val) && val.length > 0) {
            this.log.warn(
              'The groups[] (Accessory Simulations) config option will be deprecated soon.'
            )
            this.log.warn(
              'Please use the device-specific sections of the config to update your simulations.'
            )
            val.forEach(x => {
              ...
              if (!this.funcs.hasProperty(this.deviceConf, id)) {
                this.deviceConf[id] = {}
              }
              for (const [k, v] of entries) {
                switch (k) {
                  ...
                  case 'ipAddress': {
                    if (typeof v !== 'string' || v === '') {
                      ...
                      if (!this.funcs.hasProperty(this.ipOverride, id)) {
                        this.ipOverride[id] = v
                      }
                    }
                    break
                  ...
                  case 'hideSensor':
                    ...
                    if (!this.funcs.hasProperty(this.deviceConf[id], k)) {
                      this.deviceConf[id][k] = v === 'false' ? false : !!v
                    }
                    break
                  case 'obstructId':
                  ...
                  case 'sensorType':
                  case 'type': {
                    const k1 = k === 'type' ? 'showAs' : k
                    const index = k1 === 'sensorType' ? 'sensors' : k1
                    const inSet = this.consts.allowed[index].includes(v)
                    if (typeof v !== 'string' || !inSet) {
                      logIgnore(key + '.' + id + '.' + k1)
                    } else {
                      if (!this.funcs.hasProperty(this.deviceConf[id], k1)) {
                        this.deviceConf[id][k1] = v
                      }
                    }
                    break
                  }
  ...
  async initialiseDevice (device) {
    try {
      ...
      const deviceConf = this.deviceConf[device.deviceid] || {}
      if (!this.funcs.hasProperty(deviceConf, 'showAs')) {
        deviceConf.showAs = 'default'
      }
      ...
      if (uiid === 126 && device.params.workMode === 2) {
        ...
        *************************/
        ...
        if (device.params.calibState === 0) {
          ...
          this.config.ignoredDevices.push(device.deviceid)
          return
        }
        ...
        ****************************/
        ...
        /***************************/
      } else if (deviceConf.showAs === 'blind') {
        /****************************
        ...
        ****************************/
        ...
        /***************************/
      } else if (deviceConf.showAs === 'door') {
        /***************************
        ...
        ***************************/
        ...
        /**************************/
      } else if (deviceConf.showAs === 'window') {
        /*****************************
        ...
        ************************************/
        ...
        accessory.control = new (require(instance))(this, accessory, devicesInHB)
        /******************************************/
      } else if (deviceConf.showAs === 'garage') {
        /****************************************
        ...
        ****************************************/
        ...
        accessory.control = new (require(instance))(this, accessory, devicesInHB)
        /***************************************/
      } else if (deviceConf.showAs === 'garage_two') {
        /****************************************
        ...
        ****************************************/
        ...
        /***************************************/
      } else if (deviceConf.showAs === 'garage_four') {
        /*****************************************
        ...
        *****************************************/
        ...
        /****************************************/
      } else if (deviceConf.showAs === 'garage_eachen') {
        /***************************
        ...
        ***************************/
        ...
        /**************************/
      } else if (deviceConf.showAs === 'lock') {
        /***************************
        ...
        ***************************/
        ...
        /**************************/
      } else if (deviceConf.showAs === 'switch_valve') {
        /**********************************
        ...
        ********************************/
        ...
        /*******************************/
      } else if (deviceConf.showAs === 'tap_two') {
        /********************************
        ...
        ********************************/
        ...
        /*******************************/
      } else if (deviceConf.showAs === 'valve') {
        /**********************************
        ...
        **********************************/
        ...
        /*********************************/
      } else if (deviceConf.showAs === 'valve_two') {
        /**********************************
        ...
        **********************************/
        ...
        /*********************************/
      } else if (deviceConf.showAs === 'valve_four') {
        /***********************************
        ...
        ***********************************/
        ...
        /**********************************/
      } else if (deviceConf.showAs === 'sensor') {
        /*******************
        SENSORS [SIMULATION]
        *******************/
        accessory = devicesInHB.get(uuid) || this.addAccessory(device, device.deviceid + 'SWX')
        ...
        /******************/
      } else if (deviceConf.showAs === 'p_button') {
        /*******************************
        ...
        *******************************/
        ...
        /******************************/
      } else if (deviceConf.showAs === 'doorbell') {
        /********************
        DOORBELL [SIMULATION]
        ********************/
        accessory = devicesInHB.get(uuid) || this.addAccessory(device, device.deviceid + 'SWX')
        ...
        /*******************/
      } else if (deviceConf.showAs === 'purifier') {
        /*********************
        ...
        *****************************************/
        ...
        deviceConf.showAs === 'dehumidifier' &&
        this.consts.devices.sensorAmbient.includes(uiid)
      ) {
        /*******************************************
        ...
        **************/
        ...
        this.consts.devices.outletSCM.includes(uiid)
      ) {
        /********************************
