...
module.exports = class deviceSensor {
  constructor (platform, accessory) {
    ...
    this.contactService = accessory.getService(this.S.ContactSensor) || accessory.addService(this.S.ContactSensor)
    this.batteryService = accessory.getService(this.S.BatteryService) || accessory.addService(this.S.BatteryService)
