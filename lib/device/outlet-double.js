...
module.exports = class deviceOutletDouble {
  ...
  async internalUIUpdate () {
    try {
      await this.platform.sendDeviceUpdate(this.accessory, { uiActive: { outlet: 0, time: 60 } })
      await this.funcs.sleep(2000)
      await this.platform.sendDeviceUpdate(this.accessory, { uiActive: { outlet: 1, time: 60 } })
    } catch (err) {
