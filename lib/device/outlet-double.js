...
module.exports = class deviceOutletDouble {
  constructor (platform, accessory) {
    ...
    if (!this.funcs.hasProperty(this.accessory.context, 'energyReadingsOne')) {
      this.accessory.context.energyReadingsOne = []
    }
    if (!this.funcs.hasProperty(this.accessory.context, 'energyReadingsTwo')) {
      this.accessory.context.energyReadingsTwo = []
    }
    if (!this.funcs.hasProperty(this.accessory.context, 'energyReadingOneTotal')) {
      this.accessory.context.energyReadingOneTotal = 0
    }
    if (!this.funcs.hasProperty(this.accessory.context, 'energyReadingTwoTotal')) {
      this.accessory.context.energyReadingTwoTotal = 0
    }
