...
module.exports = class deviceLightColour {
  constructor (platform, accessory) {
    ...
    if (platform.api.version === 2.7 && platform.api.versionGreaterOrEqual('1.3.0-beta.27')) {
  ...
  async internalColourTempUpdate (value, callback) {
    try {
      ...
      if (!this.lightService.getCharacteristic(this.Characteristic.On).value) return
