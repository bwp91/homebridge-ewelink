...
module.exports = class deviceLightColour {
  constructor (platform, accessory) {
    ...
    if (platform.config.bulbB02FST64.includes(this.accessory.context.eweDeviceId)) {
      this.minK = 1800
      this.maxK = 5000
    } else if (platform.config.bulbB02BA60.includes(this.accessory.context.eweDeviceId)) {
      this.minK = 2700
      this.maxK = 6500
    } else {
      this.minK = 2200
    ...
    if (
      ...
      // Setup the adaptive lighting controller
