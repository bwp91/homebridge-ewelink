        ...
        if (helpers.hasProperty(params, 'ltype')) {
          ...
          if (mode === 'white' && helpers.hasProperty(params, 'white')) {
            ...
            if (helpers.hasProperty(params.white, 'ct')) {
              ...
              /*
                @BETA
                check for any difference in ct and disable Adaptive Lighting
                temperature could have been changed by user on the ewelink app
                if (this.accessory.context.cacheCT !== params.white.ct) {
