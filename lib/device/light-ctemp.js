        ...
        if (helpers.hasProperty(params, 'ltype')) {
          ...
          if (mode === 'white' && helpers.hasProperty(params, 'white')) {
            if (helpers.hasProperty(params.white, 'br')) {
              lightService.updateCharacteristic(this.Characteristic.Brightness, params.white.br)
            }
            if (helpers.hasProperty(params.white, 'ct')) {
              ...
              lightService.updateCharacteristic(this.Characteristic.ColorTemperature, kToMired)
