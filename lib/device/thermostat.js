...
module.exports = class deviceThermostat {
  ...
  async externalUpdate (params) {
    try {
      ...
      if (helpers.hasProperty(params, 'currentTemperature')) {
      ...
      if (
        helpers.hasProperty(params, 'currentHumidity') && this.service.testCharacteristic(this.Characteristic.CurrentRelativeHumidity)
      ) {
