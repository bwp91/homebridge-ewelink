...
module.exports = class deviceThermostat {
  ...
  async externalUpdate (accessory, params) {
    try {
      ...
      if (helpers.hasProperty(params, 'currentTemperature') && accessory.getService(Service.TemperatureSensor)) {
      ...
      if (helpers.hasProperty(params, 'currentHumidity') && accessory.getService(Service.HumiditySensor)) {
