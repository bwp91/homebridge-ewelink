  ...
  constructor (platform, accessory) {
    ...
    if (['curtain', 'button'].includes(this.accessory.context.subType)) {
      Object.entries(this.accessory.context.buttons).forEach(([chan, name]) => {
        if (!this.accessory.getService(name)) this.accessory.addService(this.S.Switch, name, 'switch' + chan)
        this.accessory.getService(name).updateCharacteristic(this.C.On, false)
        this.accessory.getService(name).getCharacteristic(this.C.On)
