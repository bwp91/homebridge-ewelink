      ...
      if (
        ...
        if (subAccessory) {
          ...
          if (params.updateSource && !subAccessory.context.disableDeviceLogging) {
            this.log('[%s] current state [button triggered].', subAccessory.displayName)
          }
          ...
          .forEach(async chan => {
            ...
            if (subAccessory) {
              ...
              if (
                ...
                if (params.updateSource && !subAccessory.context.disableDeviceLogging) {
                  this.log('[%s] current state [triggered].', subAccessory.displayName)
                }
