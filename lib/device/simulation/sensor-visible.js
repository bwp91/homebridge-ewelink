          ...
          if (this.devicesInHB.has(uuid)) {
            ...
            switch (newState) {
              case 0:
                ...
                gdService.updateCharacteristic(this.hapChar.ContactSensorState, 0)
                subAccessory.eveService.addEntry({ status: 1 }) // swapped
              ...
              case 1: {
                ...
                gdService.updateCharacteristic(this.hapChar.ContactSensorState, 1)
