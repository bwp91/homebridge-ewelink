...
module.exports = class deviceTHHeater {
  constructor (platform, accessory) {
    ...
    this.targetTempThreshold =
      deviceConf && deviceConf.targetTempThreshold
        ? deviceConf.targetTempThreshold
        : platform.consts.defaultValues.targetTempThreshold
    this.humiOffset =
