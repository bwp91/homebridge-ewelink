      ...
      switch (valve) {
        case 'Valve A':
          ...
          params.switches[1].switch = this.accessory.getService('Valve B').getCharacteristic(this.hapChar.Active).value === 1
            ? 'on'
            : 'off'
          params.switches[2].switch = this.accessory.getService('Valve C').getCharacteristic(this.hapChar.Active).value === 1
            ? 'on'
            : 'off'
          params.switches[3].switch = this.accessory.getService('Valve D').getCharacteristic(this.hapChar.Active).value === 1
            ? 'on'
            : 'off'
          break
        case 'Valve B':
