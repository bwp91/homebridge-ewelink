...
module.exports = class deviceSwitchSingle {
  ...
  async internalStateUpdate (service, value) {
    try {
      ...
      this.platform.sendDeviceUpdate(this.accessory, params)
      switch (service) {
        case this.service1: {
          this.cacheState1 = newValue
          if (this.enableLogging) {
            this.log('[%s] %s [%s].', service.displayName, this.lang.curState, this.cacheState1)
          }
          break
        }
        case this.service2: {
          ...
          if (this.enableLogging) {
            this.log('[%s] %s [%s].', service.displayName, this.lang.curState, this.cacheState2)
          }
          break
        }
      }
