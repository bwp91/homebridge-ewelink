...
module.exports = class deviceDiffuser {
  constructor (platform, accessory) {
    ...
    this.fanService = accessory.getService('Diffuser') || accessory.addService(this.S.Fan, 'Diffuser', 'diffuser')
    this.lightService = accessory.getService('Light') || accessory.addService(this.S.Lightbulb, 'Light', 'light')
