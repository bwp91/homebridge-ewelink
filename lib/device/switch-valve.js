...
module.exports = class deviceSwitchValve {
  constructor (platform, accessory) {
    ...
    this.sService = accessory.getService(this.S.Switch) || accessory.addService(this.S.Switch)
    if (!(this.vService = accessory.getService(this.S.Valve))) {
      this.vService = accessory.addService(this.S.Valve)
