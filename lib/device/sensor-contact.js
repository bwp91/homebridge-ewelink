...
module.exports = class deviceSensorContact {
  constructor (platform, accessory) {
    ...
    // Add the get handler to the contact sensor state characteristic
    this.service.getCharacteristic(this.hapChar.ContactSensorState).onGet(() => {
      if (this.isOnline) {
        return this.service.getCharacteristic(this.hapChar.ContactSensorState).value
      } else {
