...
module.exports = class deviceLightColour {
  ...
  async internalHueUpdate (value, callback) {
    try {
      ...
      callback()
      let params
      const newRGB = this.helpers.hsv2rgb([value, this.lightService.getCharacteristic(this.Characteristic.Saturation).value, 100])
      ...
      if (isOn) {
        ...
        switch (this.accessory.context.eweUIID) {
          case 22:
            ...
            if (mode === 2) {
              newColour = this.helpers.rgb2hsv([
          ...
          case 59:
            ...
            if (this.helpers.hasProperty(params, 'colorR')) {
              newColour = this.helpers.rgb2hsv(params.colorR, params.colorG, params.colorB)
              this.lightService
                .updateCharacteristic(this.Characteristic.Hue, newColour[0])
