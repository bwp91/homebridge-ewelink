...
module.exports = class deviceLightColour {
  ...
  async internalColourUpdate (value, callback) {
    try {
      ...
      callback()
      let params
      const newRGB = this.colourUtils.hs2rgb(value, this.service.getCharacteristic(this.Characteristic.Saturation).value)
  ...
  async internalCTempUpdate (value, callback) {
    try {
      ...
      this.cacheHue = hs[0]
      this.service.updateCharacteristic(this.Characteristic.Hue, this.cacheHue)
