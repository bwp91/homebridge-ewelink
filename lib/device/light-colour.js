...
module.exports = class deviceLightColour {
  constructor (platform, accessory) {
    ...
    if ([59, 104].includes(accessory.context.eweUIID)) {
      ...
      if (platform.api.versionGreaterOrEqual && platform.api.versionGreaterOrEqual('1.3.0-beta.41')) {
        this.cacheBrightness = this.service.getCharacteristic(this.Characteristic.Brightness).value
  ...
  async internalColourUpdate (value, callback) {
    try {
      ...
      this.cacheHue = value
      this.service.updateCharacteristic(this.Characteristic.ColorTemperature, 140)
      callback()
      let params
      const newRGB = this.helpers.hs2rgb([value, this.service.getCharacteristic(this.Characteristic.Saturation).value])
  ...
  async internalCTempUpdate (value, callback) {
    try {
      ...
      const hs = this.helpers.m2hs(this.cacheMired)
      this.cacheHue = hs[0]
      this.service
      ...
      switch (this.accessory.context.eweUIID) {
        case 59: {
          ...
          const newRGB = this.helpers.hs2rgb([
            hs[0],
            this.service.getCharacteristic(this.Characteristic.Saturation).value
          ])
          this.cacheR = newRGB[0]
          this.cacheG = newRGB[1]
          this.cacheB = newRGB[2]
  ...
  async externalUpdate (params) {
    try {
      ...
      if (
        ...
        this.service.updateCharacteristic(this.Characteristic.On, this.cacheOnOff === 'on')
        if (this.isB1) this.service.updateCharacteristic(this.Characteristic.Brightness, this.cacheOnOff === 'on' ? 100 : 0)
          ...
          if (mode === 2) {
            if (this.helpers.hasProperty(params, 'channel2')) {
              if (
                ...
                hs = this.helpers.rgb2hs([this.cacheR, this.cacheG, this.cacheB])
                this.cacheHue = hs[0]
                this.service
                  .updateCharacteristic(this.Characteristic.Hue, this.cacheHue)
        ...
        case 59:
          ...
          if (this.helpers.hasProperty(params, 'bright')) {
            if (params.bright !== this.cacheBrightness) {
              ...
              this.service.updateCharacteristic(this.Characteristic.Brightness, this.cacheBrightness)
        ...
        case 104:
          ...
          if (params.ltype === 'white' && params.white) {
            ...
            if (this.helpers.hasProperty(params.white, 'ct') && params.white.ct !== this.cacheCT) {
              ...
              hs = this.helpers.m2hs(this.cacheMired)
              this.cacheHue = hs[0]
              this.service
                .updateCharacteristic(this.Characteristic.Hue, this.cacheHue)
                .updateCharacteristic(this.Characteristic.Saturation, hs[1])
                .updateCharacteristic(this.Characteristic.ColorTemperature, this.cacheMired)
              if (params.updateSource) {
