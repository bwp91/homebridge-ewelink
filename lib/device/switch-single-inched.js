...
module.exports = class deviceSwitchSingleInched {
  constructor (platform, accessory) {
    ...
    */
    ...
    if (
      platform.consts.devices.switchSCM.includes(this.accessory.context.eweUIID) ||
      platform.consts.devices.switchSCMPower.includes(this.accessory.context.eweUIID)
    ) {
      this.isSCM = true
    }
