...
module.exports = class deviceGarageFour {
  constructor (platform, accessory) {
    ...
    this.operationTime = platform.cusG.get(accessory.context.eweDeviceId).operationTime
    ;['A', 'B', 'C', 'D'].forEach(v => {
      let gdService
  ...
  async internalUpdate (garage, value, callback) {
    try {
      ...
      gdService.updateCharacteristic(this.Characteristic.TargetDoorState, value)
