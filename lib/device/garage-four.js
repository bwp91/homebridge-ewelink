    ...
    try {
      ...
      const prevState = sAccessory
        ? sAccessory.getService(this.Service.ContactSensor).getCharacteristic(this.Characteristic.ContactSensorState).value === 0
          ? 1
          : 0
        : this.accessory.context[garageChannel].cacheCurrentDoorState
      ...
      this.accessory.context[garageChannel].cacheTargetDoorState = value
      this.accessory.context[garageChannel].cacheCurrentDoorState = value + 2
      ...
      if (!sAccessory) {
        ...
        this.accessory.context[garageChannel].cacheCurrentDoorState = value
      }
