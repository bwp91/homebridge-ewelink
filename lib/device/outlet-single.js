  ...
  async externalUpdate(params) {
    try {
      ...
      if (hasProperty(params, 'power')) {
        power = Math.round(parseFloat(params.power) / this.divisor);
        this.service.updateCharacteristic(
      ...
      if (hasProperty(params, 'voltage')) {
        voltage = Math.round(parseFloat(params.voltage) / this.divisor);
        this.service.updateCharacteristic(this.eveChar.Voltage, voltage);
        logger = true;
      }
      if (hasProperty(params, 'current')) {
        current = Math.round(parseFloat(params.current) / this.divisor);
