...
module.exports = class deviceFan {
  constructor (platform, accessory) {
    ...
    const fanService = accessory.getService(this.Service.Fanv2) || accessory.addService(this.Service.Fanv2)
    fanService
  ...
  async internalUpdate (type, value, callback) {
    ...
    try {
      ...
      if (this.visibleLight) lightService.updateCharacteristic(this.Characteristic.On, newLight)
      fanService
