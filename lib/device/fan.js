    ...
    try {
      ...
      switch (type) {
        case 'speed':
          ...
          newSpeed = value
          newLight = this.visibleLight ? this.lightService.getCharacteristic(this.Characteristic.On).value : true
          break
        case 'light':
          newPower = this.fanService.getCharacteristic(this.Characteristic.On).value
          newSpeed = this.fanService.getCharacteristic(this.Characteristic.RotationSpeed).value
