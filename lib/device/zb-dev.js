    ...
    switch (accessory.context.eweUIID) {
      ...
      case 1256:
        if (accessory.getService(this.Service.BatteryService)) {
          accessory.removeService(accessory.getService(this.Service.BatteryService))
        }
        ...
        accessory.getService(this.Service.Switch).getCharacteristic(this.Characteristic.On)
      ...
      switch (this.accessory.context.eweUIID) {
        case 1000:
          if (this.helpers.hasProperty(params, 'key') && [0, 1, 2].includes(params.key)) {
            this.accessory.getService(this.Service.StatelessProgrammableSwitch)
        ...
        case 2026:
          if (this.helpers.hasProperty(params, 'motion') && this.helpers.hasProperty(params, 'trigTime')) {
            ...
            this.accessory.getService(this.Service.MotionSensor)
              .updateCharacteristic(this.Characteristic.MotionDetected, motionDetected)
            break
          }
          break
        case 3026:
