                  ...
                  <tbody>
                    <tr>
                      <td class="small">
                        ...
                        Returns an <code>array</code>, for example:<br>
                        <code><pre>{
  "success": true,
  "response":[
    {
        ...
        "ip": "192.168.1.20"
                    ...
                    <tr>
                      <td class="small">
                        ...
                        Returns an <code>object</code>, for example:<br>
                        <code><pre>{
  "success": true,
  "response": {
    "status": {
              ...
              <div class="table-responsive">
                <table class="table table-sm table-hover">
                  ...
                  <tr>
                    ...
                    <tr>
                      <td class="small">
                        <strong>Fan:</strong> set the speed to <code>medium</code>.<br>
                        Command range:<br>
                        Must be <code>low</code>, <code>medium</code> or <code>high</code>.
                      </td>
