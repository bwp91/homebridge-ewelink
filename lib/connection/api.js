        ...
        <div class="container-fluid my-3">
          <div class="row content">
            ...
            <div class="col-lg-8">
              ...
              <ul class="small">
                ...
                <li>A note about offline devices:
                  <ul>
                    ...
                    <li>Updating an characteristic which matches the HomeKit cache value will return a <code>success:true</code> response</li>
                    <li>Updating an characteristic which does not match the HomeKit cache value will return a <code>success:false</code> with an <code>error:"HAP Status Error: -70402"</code> response</li>
                  </ul>
                </li>
              </ul>
              ...
              <div class="table-responsive">
                <table class="table table-sm table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="small">
                        Obtain a device's current state as an object.<br>
                        Example response:<br>
                        <code>{"success":true,"response":{}}</code>
                      </td>
              ...
              <div class="table-responsive">
                <table class="table table-sm table-hover">
                  ...
                  <tr>
                    ...
                    <tr>
                      <td class="small">
                        <strong>Switch:</strong> set the state to <code>on</code>.<br>
                        Command range:<br>
                    ...
                    <tr>
                      <td class="small">
                        <strong>Switch:</strong> set the state to <code>off</code>.<br>
                        Command range:<br>
                        Must be <code>off</code>.
                      </td>
                      <td class="align-middle small"><code>/set/{hbDeviceId}/switch/state/off</code></td>
                    </tr>
                    <tr>
                      <td class="small">
                        <strong>Switch:</strong> <code>toggle</code> the current state.<br>
                        Command range:<br>
                        Must be <code>toggle</code>.
                      </td>
                      <td class="align-middle small"><code>/set/{hbDeviceId}/switch/state/toggle</code></td>
                    </tr>
                    <tr>
                      <td class="small">
                        <strong>Outlet:</strong> set the state to <code>on</code>.<br>
                        Command range:<br>
                        Must be <code>on</code>.
                      </td>
                      <td class="align-middle small"><code>/set/{hbDeviceId}/outlet/state/on</code></td>
                    </tr>
                    <tr>
                      <td class="small">
                        <strong>Outlet:</strong> set the state to <code>off</code>.<br>
                        Command range:<br>
                        Must be <code>off</code>.
                      </td>
                    ...
                    <tr>
                      <td class="small">
                        <strong>Outlet:</strong> <code>toggle</code> the current state.<br>
                        Command range:<br>
                        Must be <code>toggle</code>.
                      </td>
                      <td class="align-middle small"><code>/set/{hbDeviceId}/outlet/state/toggle</code></td>
                    </tr>
                    <tr>
                      <td class="small">
                        <strong>Light:</strong> set the state to <code>on</code>.<br>
                        Command range:<br>
                        Must be <code>on</code>.
                      </td>
                    ...
                    <tr>
                      <td class="small">
                        <strong>Light:</strong> set the state to <code>off</code>.<br>
                        Command range:<br>
                        Must be <code>off</code>.
                      </td>
                      <td class="align-middle small"><code>/set/{hbDeviceId}/light/state/off</code></td>
                    </tr>
                    <tr>
                      <td class="small">
                        <strong>Light:</strong> <code>toggle</code> the current state.<br>
                        Command range:<br>
                        Must be <code>toggle</code>.
                      </td>
                      <td class="align-middle small"><code>/set/{hbDeviceId}/light/state/toggle</code></td>
                    </tr>
                    <tr>
                      <td class="small">
                        <strong>Light:</strong> set the brightness to <code>54</code>%.<br>
                        Command range:<br>
                    ...
                    <tr>
                      <td class="small">
                        <strong>Light:</strong> set the hue to <code>157</code>°.<br>
                        Command range:<br>
                    ...
                    <tr>
                      <td class="small">
                        <strong>Light:</strong> set the colour temperature to <code>300</code> mired.<br>
                        Command range:<br>
              ...
              <h5 class="mt-4 mb-2">Example Responses</h5>
              <div class="table-responsive">
                <table class="table table-sm table-hover">
                  <thead>
                    <tr>
                      <th scope="col" class="small" style="width: 50%;">Device List Array</th>
                      <th scope="col" class="small" style="width: 50%;">Device Query Object</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
    ...
    "switch": {
      "state": "off"
                        ...
                        <ul>
                          ...
                          <li>Possible services include <code>switch</code>, <code>outlet</code> and <code>light</code>
                          <li>Each service will have a corresponding object of characteristics, in this example the service is <code>switch</code> and a characteristic is <code>state</code></li>
                          <li>Use the service and characteristic when using the API to control an accessory</li>
                        </ul>
                      </td>
                    </tr>
                  </tbody>
  ...
  async action (req) {
    ...
    if (action === 'get') {
      ...
      return {
        ...
        ...accessory.control.currentState()
      }
    }
    ...
    switch (charToUpdate) {
      ...
      case 'brightness':
        ...
        break
      case 'hue':
        charName = accServ.testCharacteristic(this.hapChar.Hue)
          ? this.hapChar.Hue
          : false
        break
      case 'state':
        charName = accServ.testCharacteristic(this.hapChar.On)
          ? this.hapChar.On
          : false
        break
      default:
    ...
    switch (charToUpdate) {
      ...
      case 'colourtemperature': {
        ...
        // Call the set handler to send the request to eWeLink
        if (accessory.alController && accessory.alController.isAdaptiveLightingActive()) {
