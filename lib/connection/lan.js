  ...
  async sendUpdate (json) {
    try {
      ...
      if (json.params.brightness) {
        ...
        this.funcs.hasProperty(json.params, 'location') &&
        this.consts.devices.switchMultiPower.includes(deviceInfo.uiid)
      ) {
        ...
        suffix = 'transmit'
      } else if (this.funcs.hasProperty(json.params, 'ltype')) {
        params.ltype = json.params.ltype
        if (this.funcs.hasProperty(json.params, 'white')) {
