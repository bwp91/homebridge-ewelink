  ...
  async sendUpdate (json, context) {
    try {
      ...
      if (json.params.brightness) {
        ...
        if (context.eweUIID === 34 && ['iFan03', 'iFan'].includes(context.eweModel)) {
          ...
          if (json.params.switches[0].outlet === 0) {
            ...
            if (json.params.switches[0].switch === 'off') {
              ...
              params.fan = 'on'
              params.speed = 3
              if (json.params.switches[1] && json.params.switches[2]) {
        ...
        suffix = 'switch'
      } else if (json.params.uiActive && context.eweUIID !== 15) {
