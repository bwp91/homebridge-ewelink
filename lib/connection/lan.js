  ...
  async startMonitor () {
    ...
    this.dns.ondata = packet => {
      try {
        ...
        this.log.warn('Could not parse DNS packet as %s', this.debug ? err : err.message)
      }
    }
