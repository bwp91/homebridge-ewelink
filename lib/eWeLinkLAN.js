  ...
  async sendUpdate (json) {
    try {
      ...
      if (Object.prototype.hasOwnProperty.call(json.params, 'switches')) {
        ...
        suffix = 'switch'
      } else if (Object.prototype.hasOwnProperty.call(json.params, 'light')) {
        params.light = json.params.light
        suffix = 'light'
      } else if (Object.prototype.hasOwnProperty.call(json.params, 'fan')) {
        params.fan = json.params.fan
        suffix = 'fan'
      } else if (Object.prototype.hasOwnProperty.call(json.params, 'speed')) {
        params.speed = json.params.speed
        suffix = 'speed'
      } else {
