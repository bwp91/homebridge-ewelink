...
module.exports = {
  ...
  paramsToKeep: [
    ...
    'currentTemperature', 'fan', 'humidity',
    'key', 'light', 'lock', 'mainSwitch',
    'mode', 'motion', 'online', 'power',
    'rfChl', 'rfList', 'rfTrig',
    'sensorType', 'setclose', 'speed',
    'state', 'switch', 'switches',
    'temperature', 'trigTime', 'type',
    'voltage', 'zyx_mode'
  ],
