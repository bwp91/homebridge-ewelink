...
module.exports = {
  ...
  allowedGroups: ['blind', 'garage', 'garage_two', 'garage_four', 'garage_eachen', 'lock', 'valve'],
  defaults: {
  ...
  paramsToKeep: [
    ...
    'channel', 'cmd', 'color', 'colorB', 'colorG',
    'colorR', 'current', 'currentHumidity',
    'currentTemperature', 'humidity',
    'key', 'lock', 'ltype', 'mainSwitch', 'mode',
    'motion', 'online', 'power', 'rfChl',
    'rfList', 'rfTrig', 'sensorType',
    'setclose', 'state', 'switch',
    'switches', 'temperature', 'trigTime',
    'type', 'voltage', 'white', 'zyx_mode'
  ],
