...
const deviceLightMulti = require('./device/light-multi')
const deviceLightSingle = require('./device/light-single')
      ...
      if (helpers.devicesCurtain.includes(device.extra.uiid)) {
        ...
        ******/
        ...
        accessory.control = (this.config.outletAsSwitch || '').split(',').includes(device.deviceid)
          ? new deviceSwitch(this, accessory)
        ...
        *********************************/
        ...
        helpers.devicesSingleSwitch.includes(device.extra.uiid) &&
        helpers.devicesSingleSwitchLight.includes(device.productModel) &&
        helpers.devicesCTempable.includes(device.extra.uiid)
      ) {
        /*******************
        LIGHTS [COLOUR TEMP]
        *******************/
        ...
        helpers.devicesSingleSwitch.includes(device.extra.uiid) &&
        helpers.devicesSingleSwitchLight.includes(device.productModel) &&
        helpers.devicesColourable.includes(device.extra.uiid)
      ) {
        /******************
        LIGHTS [COLOUR RGB]
        ******************/
        ...
        helpers.devicesSingleSwitch.includes(device.extra.uiid) &&
        helpers.devicesSingleSwitchLight.includes(device.productModel) &&
        helpers.devicesBrightable.includes(device.extra.uiid)
      ) {
        /**************
        LIGHTS [DIMMER]
        **************/
        ...
        *****************************/
        accessory = this.devicesInHB.has(device.deviceid + 'SWX')
          ? this.devicesInHB.get(device.deviceid + 'SWX')
          : this.addAccessory(device, device.deviceid + 'SWX')
        accessory.control = (this.config.lightAsSwitch || '').split(',').includes(device.deviceid)
          ? new deviceSwitch(this, accessory)
          : new deviceLightSingle(this, accessory)
        /****************************/
      } else if (
        helpers.devicesMultiSwitch.includes(device.extra.uiid) &&
        helpers.devicesMultiSwitchLight.includes(device.productModel)
      ) {
        /****************************
        LIGHTS [ON/OFF MULTI CHANNEL]
        ****************************/
        ...
        accessory.control = (this.config.lightAsSwitch || '').split(',').includes(device.deviceid)
          ? new deviceSwitch(this, accessory)
          : new deviceLightMulti(this, accessory)
        for (let i = 1; i <= helpers.chansFromUiid[device.extra.uiid]; i++) {
          ...
          oAccessory.control = (this.config.lightAsSwitch || '').split(',').includes(device.deviceid)
          ? new deviceSwitch(this, oAccessory)
          : new deviceLightMulti(this, oAccessory)
        }
        /***********************/
